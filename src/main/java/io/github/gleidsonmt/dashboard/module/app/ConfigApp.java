 ...
 */
package io.github.gleidsonmt.dashboard.module.app;

import io.github.gleidson28.decorator.GNDecorator;
import io.github.gleidsonmt.dashboard.global.badges.AlertBadge;
import io.github.gleidsonmt.dashboard.global.badges.MessageBadge;
import io.github.gleidsonmt.dashboard.global.badges.NotificationBadge;
...
public enum ConfigApp {
    ...
    ConfigApp() {
        ...
        badges.getStyleClass().addAll("badges");

        MessageBadge messageBadge = new MessageBadge();

        NotificationBadge notificationBadge = new NotificationBadge();

        AlertBadge alertBadge = new AlertBadge();

        badges.getChildren().addAll(messageBadge, notificationBadge, alertBadge);
