 ...
 */
package io.github.gleidsonmt.dashboard.module.utilities;
...
import io.github.gleidsonmt.dashboard.global.creators.SnackType;
...
//        config();
    ...
    private void createContent() {
        ...
        properties.stringPropertyNames().forEach( f -> {
            ...
            left.setStyle("-fx-background-color : derive(" + color + ", -10%);");
...
//                    "}");
            ...
            right.setStyle(" -fx-background-color : derive(" + color + ", 20%);");
            ...
            child.setStyle("-fx-border-color : -border-color; -fx-border-width : 2px; -fx-background-radius : 10px; -fx-background-color : white;");
