 ...
 */
public class LeadIconTypeConverter extends StyleConverterImpl<String, Icons> {
    ...
    public Icons convert(ParsedValue<String, Icons> value, Font notUsedFont) {
        ...
        try {
            ...
            Logger.getLogger(LeadIconTypeConverter.class.getName()).info(String.format("Invalid button type value '%s'", string));
