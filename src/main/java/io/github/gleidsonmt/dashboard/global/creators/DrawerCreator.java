 ...
 */
package io.github.gleidsonmt.dashboard.global.creators;
...
//        App.decorator.hideCustomControls();
    ...
    private void organizeInCenter(){
        ...
        double width = ConfigApp.INSTANCE.getDecorator().getWidth();
        double height = ConfigApp.INSTANCE.getDecorator().getHeight();
    ...
    private void defineContents(){
        foreground = (StackPane)  ConfigApp.INSTANCE.getDecorator().lookup("#foreground");
...
//        close.play();
    ...
    private void unlock(){
         ConfigApp.INSTANCE.getDecorator().unLockControls();
    }

    private void lock(){
        ConfigApp.INSTANCE.getDecorator().lockControls();
    }
