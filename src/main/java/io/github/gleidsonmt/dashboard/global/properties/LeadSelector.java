...
import io.github.gleidsonmt.dashboard.global.controls.textField.ActionButtonType;
import io.github.gleidsonmt.dashboard.global.controls.textField.LeadIconType;
...
public class LeadSelector extends Selector {
    ...
    public void addOptions(String... options) {
        ...
        setMargin(title, new Insets(10,0,0,0));
