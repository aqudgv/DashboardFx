...
import io.github.gleidsonmt.dashboard.global.creators.PopupCreator;
...
public enum ViewManager {
    ...
    public void navigate(String name) throws NavigationException {
        ...
        if(viewController.getRoot() == null)
            ...
            ConfigApp.INSTANCE.setContent(viewController.getRoot());
    ...
    private void getContents() {
         decorator = ConfigApp.INSTANCE.getDecorator();
