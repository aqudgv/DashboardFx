 ...
 */
public class PropertyContent extends ScrollPane {
    ...
    public PropertyContent(Control control) {
...
//        BorderPane.setMargin(this, new Insets(20));
        ...
        body.getChildren().addAll(createSeparator(), createBox("StyleClass", "Your StyleClass", PropertyContent.BoxType.STYLE));
        body.getChildren().addAll(createSeparator(), createBox("Java", "CheckBox checkBox = new CheckBox(\"CheckBox\");", PropertyContent.BoxType.JAVA));
        body.getChildren().addAll(createSeparator(), createBox("FXML", "<CheckBox text=\"CheckBox\">", PropertyContent.BoxType.FXML));
...
//                if(c.wasAdded())
    ...
    private VBox createBox(String title, String prompt, PropertyContent.BoxType type) {
        return createBox(title, prompt, type, null);
    }

    private VBox createBox(String title, String prompt, PropertyContent.BoxType type, String text) {
        VBox box = new VBox();
