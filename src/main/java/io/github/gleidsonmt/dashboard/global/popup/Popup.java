 ...
 */
package io.github.gleidsonmt.dashboard.global.popup;
...
import io.github.gleidsonmt.dashboard.module.layout.LayoutController;
...
public class Popup extends PopOver {
    ...
    public void showOnWindow() {
        ...
        this.show(ConfigApp.INSTANCE.getDecorator().getWindow());
